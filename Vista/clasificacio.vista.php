    ...
    <div class="container-fluid text-center justify-content-center">
      <div class="row row-cols-1 row-cols-md-2 text-center justify-content-center">
        ...
        for ($i = 0; $i < count($grups); $i++) {
          echo ("<div class='card grup text-center mx-2 my-2'> <div class='card-body'> <h4 class='card-title'>" . ($i + 1) . ". " . ($grups[$i]["nom"]) . "</h4><h5> Victories: " . ($grups[$i]["victories"]) . "</h5><hr><button class='btn btn-dark'>Generar Diplomes</button></div></div>");
        }
        ?>
      </div>
    </div>
